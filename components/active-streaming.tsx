        ...
        <div className="px-4 py-6 sm:px-0">
            <div>
              ...
              <div className='py-8 sm:grid md:grid-cols-2 sm:gap-4 md:gap-8 lg:grid-cols-3'>
                <Link href={"/streaming"}>
                  <div className="bg-slate-800 max-w-md rounded-2xl overflow-hidden shadow-lg h-80 sm:max-w-sm sm:h-72 hover:cursor-pointer transition duration-200 ease-in transform md:hover:scale-105 hover:z-50">
                ...
                <Link href={"/streaming"}>
                  <div className="bg-slate-800 my-8 md:my-0 max-w-md rounded-2xl overflow-hidden shadow-lg h-80 sm:max-w-sm md:h-72 hover:cursor-pointer transition duration-200 ease-in transform md:hover:scale-105 hover:z-50">
                ...
                <Link href={"/streaming"}>
                  <div className="bg-slate-800 md:my-8 lg:my-0 max-w-md rounded-2xl overflow-hidden shadow-lg h-80 sm:max-w-sm md:h-72 hover:cursor-pointer transition duration-200 ease-in transform md:hover:scale-105 hover:z-50">
