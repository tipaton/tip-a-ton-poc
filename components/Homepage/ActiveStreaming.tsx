              ...
              <div className='py-8 space-y-8 sm:space-y-0 sm:grid md:grid-cols-2 sm:gap-4 md:gap-8 lg:grid-cols-3'>
                <Link href={"/streaming"}>
                  <div className="max-w-md bg-gradient-to-bl from-blue-400/30 to-slate-800 p-2 rounded-lg transition duration-200 ease-in transform md:hover:scale-105 hover:z-50">
                    <div className="bg-black max-w-md rounded-lg overflow-hidden shadow-lg h-64 md:h-72 sm:max-w-sm hover:cursor-pointer ">
                      <Image src={SampleML} alt="Mobile Legend Streaming" layout="responsive" className='rounded-t-lg'/>
                      <div className='flex items-center justify-between py-4 px-4 text-white text-lg md:text-xl font-bold'>
